<script>
	import systemDesign from '../../../wa-chatbot-system-design.png';
</script>

<div id="container" class="flex-1 overflow-y-auto my-20">
	<div class="w-1/4 mb-10 flex items-center justify-center">
		<a href="/" class="flex items-center justify-center cursor-pointer hover:font-bold">
			<i class="bi bi-arrow-left text-yellow-500 text-3xl" />
			<div class="bg-[#D9D9D9] rounded-full w-[50px] h-[50px]" />
			<p class="-ml-[25px] mr-2 font-mono">Back to Home</p>
		</a>
	</div>
	<div id="project-detail" class="mx-36">
		<p class="leading-10 font-[Helvetica Neue] font-normal antialiased text-xl">
			Imagine being able to pay your bills without the need for a separate app, saving your phone's
			storage space. Users can handle the entire process within the familiar environment of
			WhatsApp, a platform everyone uses nowadays.
		</p>
		<p class="leading-10 font-[Helvetica Neue] font-normal antialiased text-xl mt-5">
			To make this possible, I’ve streamlined the process. I’ve registered a dedicated WhatsApp
		...
		<div class="flex items-center justify-center flex-col my-10">
			<img
				src={systemDesign}
				class="w-[680px] border-2 border-black-300 p-10"
				alt="System Design"
			/>
			<p class="text-lg font-extralight m-auto">The System Design</p>
		</div>

		<p class="leading-10 font-[Helvetica Neue] font-normal antialiased text-xl">
			Behind the scenes, I’ve built the software logic using Node.js. For secure and reliable
			...
			with their RPC, enabling quick and secure transactions.
		</p>
		<p class="leading-10 font-[Helvetica Neue] font-normal antialiased text-xl mt-5">
		...
		<div class="flex items-center justify-center flex-col my-10">
			<a
				...
				class="text-lg font-extralight m-auto underline"
				target="_blank"
