// import image from "./kitchenTable.jpeg";
import "./App.css";
...
function App() {
  return (
    <div className="App">
      ...
      {/* Dummy div */}
      {/* <div>
        <h1 style={{ color: "white" }}>Dummy div. Idk why if </h1>
      </div> */}
      {/* ==== Background Image ===== */}
      <div
        style={{
      ...
      <div style={{ marginTop: "10em" }}>
        <h1 style={{ color: "gray" }}>Catering services in New York</h1>
        <h1 style={{ color: "gray" }}>
      ...
      <div className="row" style={{ color: "white", height: "65vh" }}>
        ...
        <div className="col-5 d-flex" style={{ backgroundColor: "#302729" }}>
          <div className="row">
            <div className="col-sm-6">
              <div class="card card-x" style={{ backgroundColor: "#36292e" }}>
                <div class="card-body">
                  <i class="bi bi-box" />
        ...
        <div className="col-4 p-3" style={{ backgroundColor: "#302729", textAlign: 'left' }}>
          ...
          <button className="btn rounded-pill" style={{color: 'white', borderColor: '#F77B81'}}>
            Download CV <i className="bi bi-chevron-right" />
          </button>
          <button className="btn rounded-pill m-3" style={{color: 'white', borderColor: '#F77B81'}}>
